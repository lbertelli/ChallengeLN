export const list = () => {
  const data = [
    ...
    },
    {
      ...
      headlines: {
        basic: "Risotto con alcauciles y frutos de mar",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "aceite-de-oliva-tid47117",
            text: "Aceite de oliva",
          },
          {
            slug: "vino-blanco-tid47349",
            text: "Vino blanco",
          },
          {
            slug: "alcaucil-tid47129",
            text: "Alcaucil",
          },
          {
            slug: "limon-tid47252",
          ...
          {
            slug: "perejil-tid47297",
            text: "Perejil",
          },
          {
            slug: "mejillon-tid47930",
            text: "Mejillón",
          },
          {
            slug: "langostinos-tid47750",
            text: "Langostinos",
          },
        ],
      },
    ...
    },
    {
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "morron-rojo-tid47270",
            text: "Morrón rojo",
          },
          {
            slug: "zanahoria-tid47352",
            text: "Zanahoria",
          },
          {
            slug: "choclo-tid47183",
            text: "Choclo",
          },
          {
            slug: "ajo-tid47126",
          ...
          {
            slug: "cebolla-de-verdeo-tid47175",
            text: "Cebolla de verdeo",
          },
          {
            slug: "pechuga-de-pollo-tid47294",
    ...
    },
    {
      ...
      headlines: {
        basic: "Arroz chaufa de mariscos",
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: "Quiche de espinacas y cherries",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          {
            slug: "quesos-tid67219",
            text: "Quesos",
          },
          {
            slug: "vegetales-tid67215",
            text: "Vegetales",
          },
          {
            slug: "espinaca-tid47216",
            text: "Espinaca",
          },
          {
            slug: "tomates-cherry-tid47342",
            text: "Tomates cherry",
          },
          {
            slug: "huevo-tid47236",
    ...
    },
    {
      ...
      headlines: {
        basic: "Pan “crunchy” de manzanas y dulce de leche",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "manzana-tid47258",
            text: "Manzana",
          },
          {
            slug: "nueces-tid47275",
            text: "Nueces",
          },
          {
            slug: "harina-leudante-tid47231",
            text: "Harina leudante",
          },
          {
            slug: "bicarbonato-tid47149",
            text: "Bicarbonato",
          },
          {
            slug: "huevo-tid47236",
    ...
    },
    {
      ...
      headlines: {
        basic: "Solomillo de cerdo con coliflor",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "coliflor-tid48542",
            text: "Coliflor",
          },
          {
            slug: "crema-de-leche-tid47204",
            text: "Crema de leche",
          },
          {
            slug: "leche-tid47244",
          ...
          {
            slug: "mostaza-en-grano-tid48687",
            text: "Mostaza en grano",
          },
          {
            slug: "romero-tid47325",
            text: "Romero",
          },
        ],
      },
    ...
    },
    {
      ...
      headlines: {
        basic: "Tarta de chocolate y avellana",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "azucar-impalpable-tid47142",
            text: "Azúcar impalpable",
          },
          {
            slug: "manteca-tid47257",
            text: "Manteca",
          ...
          {
            slug: "chocolate-amargo-tid47185",
            text: "Chocolate amargo",
          },
          {
            slug: "avellana-tid49037",
            text: "Avellana",
          },
          {
    ...
    },
    {
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "polvo-de-hornear-tid47308",
            text: "Polvo de hornear",
          },
        ],
      },
    ...
    },
    {
      ...
      headlines: {
        basic: '"Sauce hollandaise" o salsa holandesa',
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "ciboulette-tid47189",
            text: "Ciboulette",
          },
          {
            slug: "estragon-tid47217",
            text: "Estragón",
          },
        ],
      },
    ...
    },
    {
      ...
      headlines: {
        basic: "“Pain perdu” o Pan perdido",
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: 'Ensalada tipo "Poke" de salmón ahumado',
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: "Piña colada como en Cuba (con y sin alcohol)",
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: "Huevo de Pascuas tradicional",
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: "Huevo de Pascuas Innovador",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      website_url:
        "/recetas/dulces/huevo-de-pascuas-innovador-nid15042019-6/",
    },
    {
      _id: "YB3KCHDMLVDLTO7VXZAUI5SRAM",
      display_date: "2019-04-15T17:25:00Z",
      headlines: {
        basic: "Huevo de Pascuas infantil",
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: "Oeufs au lait o huevos con leche",
      },
      promo_items: {
        basic: {
          resized_urls: [
    ...
    },
    {
      ...
      headlines: {
        basic: "Helado de duraznos y mascarpone",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "queso-mascarpone-tid48545",
    ...
    },
    {
      ...
      headlines: {
        basic: "Ensalada fría de couscous de coliflor",
      },
      promo_items: {
        basic: {
          resized_urls: [
      ...
      taxonomy: {
        tags: [
          ...
          {
            slug: "tomate-tid47341",
            text: "Tomate",
          },
          {
            slug: "pepino-tid47295",
            text: "Pepino",
          },
          {
            slug: "cebolla-morada-tid47808",
    ...
    },
    {
      ...
      headlines: {
        basic: "Hamburguesa de berenjenas",
      },
      promo_items: {
        basic: {
          resized_urls: [
